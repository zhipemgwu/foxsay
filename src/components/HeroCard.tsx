              ...
              {messages.map((msg, i) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background: msg.role === 'user' ? '#FF8A80' : msg.role === 'system' ? '#453a60' : '#453a60',
            ...
            <div className="px-5 py-3" style={{ borderTop: '1px solid rgba(245,239,232,0.10)', paddingBottom: 'env(safe-area-inset-bottom, 16px)' }}>
              <div className="flex items-center gap-3">
                ...
                <motion.button
                  ...
                  style={{ background: input.trim() ? '#FF8A80' : '#453a60' }}
                  whileTap={{ scale: 0.9 }}
                  onClick={sendMessage}
                >
              ...
              <div className="flex gap-2 mt-2">
                {['你好，我注意到...', '这本书真不错', '可以聊聊吗？'].map(s => (
                  <button
                    ...
                    style={{ background: '#453a60', borderRadius: 980, color: 'rgba(245,239,232,0.65)', fontSize: '12px' }}
                    onClick={() => { setInput(s); }}
                  >
                    {s}
                  </button>
